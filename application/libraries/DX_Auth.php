...
class DX_Auth
{
	...
	*/
	...
	function _get_role_data($role_id)
	{
		...
		//$data['name'] = $this->ci->users->get_user_field($id, 'name');
		//var_dump($this->ci->users);
		$data['name'] = "Joe Doe";
		return $data;
	}
	...
	function _set_session($data)
	{
		...
		$user = array(						
			...
			'DX_name'						=> $data->name,
			'DX_institution_id'						=> $data->institution_id,
			'DX_building_id'						=> $data->building_id,
	...
	*/
	...
	{
		return $this->ci->session->userdata('DX_institution_id');
	}

	// Get username string
	function get_building_id()
	{
		return $this->ci->session->userdata('DX_building_id');
	}
	
	// Get username string
	function get_userrealname()
	{
	/*	
		$config['hostname'] = "localhost";
		$config['username'] = "root";
		$config['password'] = "root";
		$config['database'] = "mrxp";
