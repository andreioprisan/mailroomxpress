...
class Users extends CI_Model 
{
	...
	function get_name_by_id($user_id)
	{
		$this->db->select('name');
		$this->db->where('id', $user_id);
		return $this->db->get($this->_table)->row()->name;
	}
	...
	function get_lastlogin_by_id($user_id)
	{
		...
		$this->db->where('id', $user_id);
		return $this->db->get($this->_table)->row()->last_login;
	}

	function get_institution_id($user_id)
	{
		$this->db->select('institution_id');
		$this->db->where('id', $user_id);
		return $this->db->get($this->_table)->row()->institution_id;
	}

	function get_building_id($user_id)
	{
		$this->db->select('building_id');
		$this->db->where('id', $user_id);
		return $this->db->get($this->_table)->row()->building_id;
	}
